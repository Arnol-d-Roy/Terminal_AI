...
**Claude Code** is a command-line interface (CLI) tool that brings Claude, Anthropic's AI assistant, directly into your terminal. Instead of switching between browser tabs and your code editor, you can get AI assistance right where you're already working.

### Why Terminal-Based AI?

| Browser AI | Claude Code (Terminal) |
|------------|------------------------|
| Copy-paste code back and forth | Direct file access |
| Context switching interrupts flow | Stay in your workflow |
| Manual file sharing | Automatic project awareness |
| Generic assistance | Context-aware help |

**Achievement Unlocked: Understanding the Mission** (+5 XP)
...
**Expected Output**: You should see a version number (e.g., `claude-code 1.0.x`)
...
**Task**: Run the version check command and confirm Claude Code is installed.
...
That's it. One word. Your terminal will transform into an interactive AI conversation.
...
Claude will respond with awareness of your current location and project context.
...
Claude Code understands natural language. You don't need special syntax or commands for basic interactions.
...
**Success Criteria**: You received helpful responses to all three questions.
...
While chatting with Claude, you can use special commands that start with `/`:

| Command | What It Does |
|---------|--------------|
| `/help` | Shows available commands |
| `/clear` | Clears the conversation history |
| `/exit` or `Ctrl+C` | Exits Claude Code |
...
**Pro Tip**: Your conversation isn't lost when you exit! You can resume it later.

**Achievement Unlocked: Command Discovery** (+5 XP)
...
One of Claude Code's most useful features is conversation resumption. Your previous context is saved!
...
2. Tell Claude something memorable (e.g., "Remember that my favorite color is blue")
3. Exit Claude Code
4. Resume with `claude -r`
5. Ask Claude "What's my favorite color?"

**Success Criteria**: Claude remembers what you told it in the previous session.
...
**Tip**: Help output is your friend. Refer to it often as you learn.
...
You've just cloned a mysterious project from GitHub. Your mission is to use Claude Code to understand what it is.
...
Complete ALL of the following in a single session (you can resume if needed):

1. **Scout the Territory**: Ask Claude to analyze your current directory structure
2. **Gather Intelligence**: Have Claude explain 3 different files in detail
3. **Test Communication**: Use at least 5 different conversational prompts
4. **Master the Tools**: Use `/help` and `/clear` appropriately
5. **Prove Persistence**: Exit, resume with `-r`, and continue seamlessly
...
If you've completed the core skills and at least the exercises, you have enough XP to proceed!
...
1. **Practice makes permanent**: Use Claude Code daily, even for small tasks
2. **Be specific**: The more context you give Claude, the better help you'll receive
3. **Experiment freely**: You can't break anything by asking questions
4. **Resume often**: The `-r` flag is your friend for ongoing projects

---

*Level 1 Complete - You are now a Claude Code Novice!*

[<-- Back to Start](./00-START-HERE.md) | [Level 2: Apprentice -->](./02-LEVEL-APPRENTICE.md)
